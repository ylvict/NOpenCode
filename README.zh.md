...
一个面向 [OpenCode](https://opencode.ai) 的 .NET SDK —— 开源终端 AI 编程助手。

NOpenCode 让你通过自然语言的 API 在 C# 中控制 OpenCode。它会自动管理 `opencode serve` 进程，让你专注于代码本身。
...
- 已安装 [OpenCode CLI](https://opencode.ai/docs/cli/) (`npm install -g @opencode/cli`)
